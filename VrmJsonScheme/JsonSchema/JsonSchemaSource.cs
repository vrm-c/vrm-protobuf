...
namespace Vrm.JsonScheme
{
    ...
    public class JsonSchemaSource
    {
        ...
        public Schemas.JsonSchemaBase Create()
        {
            // if (baseSchema != null)
            // {
            ...
            switch (type)
            {
                case JsonSchemaType.Object:
                    ...
                    {
                        return new Schemas.ObjectJsonSchema(this);
                    }
                    else
                    {
                        return new Schemas.DictionaryJsonSchema(this);
                    }
                case JsonSchemaType.Array:
                    return new Schemas.ArrayJsonSchema(this);
                case JsonSchemaType.Boolean:
                    return new Schemas.JsonSchemaBase(this);
